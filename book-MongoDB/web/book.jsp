                            ...
                            <table width="100%" height="144" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <c:forEach items="${requestScope.booklist}" var="book">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:if(confirm('确认要删除吗？'))location='bookServlet?action=delbook&createOrderNum=${book.getCreateOrderNum()}'">[删除]</a>
                                            &nbsp;&nbsp;&nbsp;
                                            <a href="changebook.jsp?bookname=${book.getBookname()}">[修改]</a>
                                            <hr/>
                                        </td>
                                    </tr>
                                </c:forEach>
